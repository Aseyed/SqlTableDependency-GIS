...
namespace GIS.Class
{
    ...
    public partial class LVPT_JUMPER
    {
        ...
        public Nullable<int> Phase_Status { get; set; }
        public Nullable<int> Null_Status { get; set; }
        public Nullable<int> Lustr_Status { get; set; }
        public string Address { get; set; }
        public Nullable<int> ConnectionKind { get; set; }
        public Nullable<int> ClampCnt { get; set; }
