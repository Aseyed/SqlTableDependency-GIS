...
namespace GIS.Class
{
    ...
    public partial class LVPT_CONTACTOR
    {
        ...
        public Nullable<int> Lustr_Pkind { get; set; }
        public string Primitive_Constructor { get; set; }
        public string Primitive_Model { get; set; }
        public Nullable<int> Lustr_Feeder_Cnt { get; set; }
