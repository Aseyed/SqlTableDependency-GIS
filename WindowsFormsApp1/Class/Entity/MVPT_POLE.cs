...
namespace GIS.Class
{
    ...
    public partial class MVPT_POLE
    {
        ...
        public Nullable<int> Node_Composite { get; set; }
        public Nullable<int> Train_Cnt { get; set; }
        public Nullable<int> LowNet_Decor { get; set; }
        public Nullable<int> Foundation_Kind { get; set; }
        public Nullable<decimal> VDistance { get; set; }
