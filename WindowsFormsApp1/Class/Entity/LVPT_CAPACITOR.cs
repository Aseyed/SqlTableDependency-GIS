...
namespace GIS.Class
{
    ...
    public partial class LVPT_CAPACITOR
    {
        ...
        public Nullable<int> Control_Kind { get; set; }
        public Nullable<int> Capacitor_Bank { get; set; }
        public Nullable<int> Capacity_Bank { get; set; }
        public Nullable<int> Capacitor_Install_Decor { get; set; }
        public Nullable<int> Phase_Cnt { get; set; }
        public Nullable<int> Stair_Cnt { get; set; }
        public Nullable<int> Damper_Kind { get; set; }
        public Nullable<int> Relation_Status { get; set; }
        public Nullable<decimal> Capacitor_Fuse_Amper { get; set; }
        public Nullable<decimal> famous_Voltage { get; set; }
