...
namespace GIS.Class
{
    ...
    public partial class MVPT_MOF
    {
        ...
        public Nullable<int> CT_Convertor { get; set; }
        public Nullable<int> PT_Convertor { get; set; }
        public Nullable<decimal> CIT_Capacity { get; set; }
