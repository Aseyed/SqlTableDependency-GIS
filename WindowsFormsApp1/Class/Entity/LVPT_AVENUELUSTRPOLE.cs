...
namespace GIS.Class
{
    ...
    public partial class LVPT_AVENUELUSTRPOLE
    {
        ...
        public Nullable<int> LustrPole_Composite { get; set; }
        public Nullable<int> Earth_Connection { get; set; }
        public Nullable<decimal> Earth_Resistance { get; set; }
        public string Meter_Date { get; set; }
        public Nullable<int> Arm_Cnt { get; set; }
