...
namespace GIS.Class
{
    ...
    public partial class MVPT_OUTGOING
    {
        ...
        public Nullable<int> Primitive_Way { get; set; }
        public Nullable<int> Operation_Kind { get; set; }
        public Nullable<decimal> Cut_Power { get; set; }
