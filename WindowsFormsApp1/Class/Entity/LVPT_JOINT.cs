...
namespace GIS.Class
{
    ...
    public partial class LVPT_JOINT
    {
        ...
        public Nullable<int> Joint_Kind { get; set; }
        public Nullable<int> Appear_Type { get; set; }
        public Nullable<int> Joint_Size { get; set; }
        public Nullable<int> Install_Depth { get; set; }
        public Nullable<decimal> Voltage_Famous { get; set; }
