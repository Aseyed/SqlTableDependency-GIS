...
namespace GIS.Class
{
    ...
    public partial class MVPT_SECTIONALIZER
    {
        ...
        public Nullable<int> Regulated_Cut_Cnt { get; set; }
        public Nullable<int> Kind { get; set; }
        public Nullable<decimal> Famous_Flow { get; set; }
        public Nullable<decimal> OnLineLoad { get; set; }
        public Nullable<int> Cut_Cnt_Max { get; set; }
        public Nullable<decimal> Isochronal_Cut_Flow { get; set; }
        public Nullable<decimal> Short_Circut_Tolorance { get; set; }
        public Nullable<decimal> Ten_Short_Circut_Tolorance { get; set; }
