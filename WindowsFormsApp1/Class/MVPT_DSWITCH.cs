...
public class MVPT_DSWITCH
{
    ...
    public decimal? Fuse_Short_Circut_Flow { get; set; }
    public decimal? Fuse_Famous_Flow { get; set; }
    public decimal? Famous_Flow { get; set; }
    public decimal? OnLineLoad { get; set; }
    public decimal? Short_Circut_Flow { get; set; }
    public decimal? Load_Closed_Flow { get; set; }
    public decimal? Load_Open_Flow { get; set; }
    public int? Automation { get; set; }
    public int? Operation_Mechanism { get; set; }
    public string Cut_Direction { get; set; }
    public int? Using_Kind { get; set; }
    public int? Kind_Composite { get; set; }
