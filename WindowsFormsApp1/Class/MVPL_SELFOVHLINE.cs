...
public class MVPL_SELFOVHLINE
{
    ...
    public int? Self_Composite { get; set; }
    public string Conductor_Constructor { get; set; }
    public int? Current_Circut_Cnt { get; set; }
    public int? Max_Circut_Cnt { get; set; }
    public int? Install_Year { get; set; }
    public decimal? Length { get; set; }
    public decimal? LengthReal { get; set; }
