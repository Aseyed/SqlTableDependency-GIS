...
public class LVPT_AVENUELUSTRPOLE
{
    ...
    public int? LustrPole_Composite { get; set; }
    public int? Earth_Connection { get; set; }
    public decimal? Earth_Resistance { get; set; }
    public string Meter_Date { get; set; }
    public int? Arm_Cnt { get; set; }
    public string Address { get; set; }
    public int? Protect_Kind { get; set; }
